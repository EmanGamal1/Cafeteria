...
// Get value of page parameter from URL if it exists, else it will equal page 1
if (!isset($_GET['page'])) {
    $page =1;
} else {
    $page = $_GET['page'];
...
// e.g. page 1 will show results 1-5, page 2 will show results 6-10
$this_page_first_result = ($page - 1) * $results_per_page;

// Retrieve selected results from database and display them on page
$query = "SELECT id,name, email, room, ext, image FROM users LIMIT " . $this_page_first_result . ',' . $results_per_page;
$stmt = $db->prepare($query);
$stmt->execute();
...
<body>
    <div class="container-fluid">
        ...
        <div>
            ...
            echo "</ul>";
            echo "</div>";
            echo "<p>Total results: $number_of_results</p>";
            ?>
        </div>
        <?php
